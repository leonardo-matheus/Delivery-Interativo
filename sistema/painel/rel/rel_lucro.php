...
<body>	
	...
	<img class="imagem" src="<?php echo $url_sistema ?>/img/logo_rel.jpg" >
  ...
  <tbody>
	...
	//totalizar os vendas 
  	$query = $pdo->query("SELECT * FROM vendas where data >= '$dataInicial' and data <= '$dataFinal' and pago = 'Sim' and status != 'Cancelado'");
